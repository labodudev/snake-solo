...
function drawUsers() {
  ...
  var headX = player.x - start.x;
  var headY = player.y - start.y;

  headX = valueInRange(-player.x - player.x + screenWidth/2, gameWidth - player.x + gameWidth - player.x + screenWidth/2, headX);
  headY = valueInRange(-player.y - player.y + screenHeight/2, gameHeight - player.y + gameHeight - player.y + screenHeight/2 , headY);
  ...
  graph.fillStyle = 'red';
  for( var i = 0; i < player.l.length; i++ ) {
      x = player.l[i].x - start.x;
      y = player.l[i].y - start.y;
      x = valueInRange(-player.x - player.x + screenWidth/2, gameWidth - player.x + gameWidth - player.x + screenWidth/2, x);
      y = valueInRange(-player.y - player.y + screenHeight/2, gameHeight - player.y + gameHeight - player.y + screenHeight/2 , y);
...
function movePlayer() {
  ...
  player.x += speed * Math.cos(player.a * Math.PI / 180);
  player.y += speed * Math.sin(player.a * Math.PI / 180);

  // if (player.x > 5000 - borderCalc) {
  //     player.x = borderCalc;
  // }
  // if (player.y > 5000 - borderCalc) {
  //     player.y = borderCalc;
  // }
  // if (player.x < borderCalc) {
  //     player.x = 5000 - borderCalc;
  // }
  // if (player.y < borderCalc) {
  //     player.y = 5000 - borderCalc;
  // }
